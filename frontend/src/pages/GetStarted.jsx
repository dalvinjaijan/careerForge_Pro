  ...
  return (
    <div className=" h-screen p-10 pt-30">
      ...
      <div className="">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 md:gap-12 m-5">
          <button
            type="button"
          ...
          <button
            ...
            class="flex items-center gap-2.5 border-2 border-blue-300 px-20 py-3 text-sm text-gray-800 rounded bg-white hover:text-blue-400 hover:bg-blue-400/10 hover:border-blue-400/50 active:scale-95 transition hover:shadow-xl shadow-blue-200 hover:scale-105"
          >
            <svg
              width="16"
              height="16"
          ...
          <button
            ...
            class="flex items-center gap-2.5 border-2 border-[#0CDBB4] px-20 py-3 text-sm text-gray-800 rounded bg-white hover:text-[#0CDBB4] hover:bg-[#0CDBB4]/10 hover:border-[#0CDBB4]/50 active:scale-95 transition hover:shadow-xl shadow-[#83f9e4] hover:scale-105"
          >
            <svg
              width="18"
              height="20"
